...
urlpatterns = [
	...
	url(r'^(?P<active_receipe>[0-9]+)/edit$', edit_receipe, name='editreceipe'),
	url(r'^(?P<active_receipe>[0-9]+)/del$', del_receipe, name='delreceipe'),
	url(r'^(?P<active_receipe>[0-9]+)/$', list_receipe_ingredient, name='receipes'),
